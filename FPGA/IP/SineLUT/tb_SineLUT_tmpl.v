...
`timescale 1 ns / 1 ps
module tb;
    reg [17:0] DataInA = 18'b0;
    reg [17:0] DataInB = 18'b0;
    reg [9:0] AddressA = 10'b0;
    reg [9:0] AddressB = 10'b0;
    reg ClockA = 0;
    reg ClockB = 0;
    reg ClockEnA = 0;
    reg ClockEnB = 0;
    ...
    SineLUT u1 (.DataInA(DataInA), .DataInB(DataInB), .AddressA(AddressA), 
    ...
    begin
      ...
      #100;
      @(ResetA == 1'b0);
      for (i3 = 0; i3 < 2054; i3 = i3 + 1) begin
        @(posedge ClockA);
    ...
    begin
      ...
      @(ResetB == 1'b0);
      @(WrB == 1'b1);
      for (i4 = 0; i4 < 2054; i4 = i4 + 1) begin
        @(posedge ClockB);
    ...
    begin
       WrA <= 1'b0;
      @(ResetA == 1'b0);
      for (i9 = 0; i9 < 1027; i9 = i9 + 1) begin
        @(posedge ClockA);
        #1  WrA <= 1'b1;
      end
       WrA <= 1'b0;
    ...
    begin
      ...
      @(WrA == 1'b1);
      @(WrA == 1'b0);
      for (i10 = 0; i10 < 1027; i10 = i10 + 1) begin
        @(posedge ClockA);
      end
      for (i10 = 0; i10 < 1027; i10 = i10 + 1) begin
        @(posedge ClockB);
